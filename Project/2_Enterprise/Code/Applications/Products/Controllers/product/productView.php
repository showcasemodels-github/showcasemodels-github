...
class productView extends applicationsSuperView
{
	...
	{
		$this->templates_location = 'Project/2_Enterprise/Design/Applications/Products/Controllers/templates/products/';
	}
...
//-------------------------------------------------------------------------------------------------
	...
	{	
		$content = $this->renderTemplate('Project/2_Enterprise/Design/Applications/Products/Controllers/templates/products/add_product_dialog.phtml');
