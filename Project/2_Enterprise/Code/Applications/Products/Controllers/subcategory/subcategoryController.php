...
require_once 'Project/Model/Products/subcategory.php';
...
//-------------------------------------------------------------------------------------------------
	...
	{ 
		...
		header('Location: /products/subcategory/edit/'.$subcategory->__get('subcategory_id'));
	}
...
//-------------------------------------------------------------------------------------------------
	...
	public function logEvent($message)
	{
		try
		{
			$fh = fopen(STAR_SITE_ROOT."/Project/2_Enterprise/Code/Applications/Products/Controllers/subcategory/log.txt", 'a') or die('no such file');
