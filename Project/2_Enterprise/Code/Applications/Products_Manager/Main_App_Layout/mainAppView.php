...
//-------------------------------------------------------------------------------------------------	
	...
	public function displayMainApplicationLayout()
	{
		...
		$content = $this->renderTemplate('Project/2_Enterprise/Design/Applications/Products_Manager/Main_App_Layout/templates/css_links.phtml');
		response::getInstance()->addContentToStack('local_css',array('PRODUCTS_CS'=>$content));
		
		$content = $this->renderTemplate('Project/2_Enterprise/Design/Applications/Products_Manager/Main_App_Layout/templates/inpage_javascript.js');
		response::getInstance()->addContentToStack('local_javascript_bottom',array('CURRENT SECTION CSS'=>$content));
		
		$content = $this->renderTemplate('Project/2_Enterprise/Design/Applications/Products_Manager/Main_App_Layout/templates/main_app_layout.phtml');
